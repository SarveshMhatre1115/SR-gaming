...
<section>
	<h4>Discover your next favourite game</h4>
	<div class="boxx">
		<a href="#" class="boxs">
		...
		<h5 style="padding-left: 91px; color: white; font-size:initial; position: absolute;">Hello,<?php echo $_SESSION['name']; ?></h5>   
              <ul>
			 <li class="btn" style="font-size: 24px; padding-left: 397px;"> 
    ...
    <div class="cardBx">
      <div class="card" data-item="Moblie">
          <img src="images\trending2.jpg">
          <div class="content">
...
<div class="card" data-item="Moblie">
  <img src="images\MN_Headball_PageThumbnail.jpg">
  <div class="content">
    <h4>Head Ball</h4>
    <div class="progress-line"><span></span></div>
    <div class="info">
...
<div class="card" data-item="Moblie">
  ...
  <div class="content">
    <h4>World Cricket Championship</h4>
    <div class="progress-line"><span></span></div>
    <div class="info">
        <p>Pricing<br><span>$10</span></p>
        <a href="#">Play Now</a>
